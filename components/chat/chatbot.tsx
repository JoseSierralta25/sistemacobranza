...
export function ChatBot() {
  ...
  return (
    <>
      ...
      {isOpen && (
        <Card 
          style={{ background: 'var(--color-background)', backdropFilter: 'none', WebkitBackdropFilter: 'none' }}
          className="fixed bottom-36 md:bottom-24 right-4 md:right-8 z-50 w-[90vw] md:w-[400px] h-[500px] max-h-[70vh] flex flex-col shadow-2xl border-outline-variant animate-in slide-in-from-bottom-10 fade-in duration-300 overflow-hidden"
        >
